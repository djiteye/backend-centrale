...
@Data
@Entity
@Table(name="chambreA2")
public class ChambreA2 {
	public int getId() {
		return id;
	}
	...
	public ChambreA2(int id,String appartement,String place,String genre, String name,String nom,String prenom,String nationalite,String passeport,LocalDate date_de_reserv,LocalDateTime date_arrive,LocalDate date_entre,Date date_sortie,boolean valider) {
		super();
		this.id=id;
		this.appartement=appartement;
		this.place=place;
