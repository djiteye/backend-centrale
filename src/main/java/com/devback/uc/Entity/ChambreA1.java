...
@Data
@Entity
@Table(name="chambreA1")
public class ChambreA1 {
	...
	public ChambreA1(int id,String appartement,String place,String genre, String name,String nom,String prenom,String nationalite,String passeport,LocalDate date_de_reserv,LocalDateTime date_arrive,LocalDate date_entre,Date date_sortie,boolean valider) {
		super();
		this.id=id;
